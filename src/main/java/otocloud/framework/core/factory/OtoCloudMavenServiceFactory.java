...
/**
 * otocloud_maven:com.mycompany:main-services:1.2::my-service
 */
public class OtoCloudMavenServiceFactory extends OtoCloudServiceFactory {
...
/*  private static final String USER_HOME = System.getProperty("user.home");
  ...
  private static final String DEFAULT_MAVEN_LOCAL = OtoCloudDirectoryHelper.getLibDirectory();
  private static final String DEFAULT_MAVEN_REMOTES =
    "https://repo.maven.apache.org/maven2/ http://172.16.51.12/nexus/content/groups/otocloud-all/";
  ...
  public OtoCloudMavenServiceFactory() {
  ...
  public void resolve(String identifier, DeploymentOptions deploymentOptions, ClassLoader classLoader, Future<String> resolution) {
    ...
    vertx.<Void>executeBlocking(fut -> {
      try {
        ...
        //int index = 0;
        List<String> extraCP = new ArrayList<>(classpath.size());
        for (String pathElement: classpath) {
          File file = new File(pathElement);
          String fileName = file.getAbsolutePath();
          //logger.warn(fileName);
          extraCP.add(fileName);
/*          try {
        ...
        deploymentOptions.setIsolationGroup(identifierNoPrefix);
